let employee = {
  ...
  // Non-destructive: returns a new employee object with the updated key-value pair
  function updateEmployeeWithKeyAndValue(employee, key, value) {
    return {
      ...employee, // Create a copy of the employee object
      [key]: value // Add or update the key with the new value
    };
  }
  
  // Destructive: modifies the original employee object
  function destructivelyUpdateEmployeeWithKeyAndValue(employee, key, value) {
    employee[key] = value; // Update or add the key-value pair to the original object
    return employee; // Return the updated employee object
  }
  
  // Non-destructive: returns a new employee object with the specified key removed
  function deleteFromEmployeeByKey(employee, key) {
    let newEmployee = { ...employee }; // Create a copy of the employee object
    delete newEmployee[key]; // Remove the specified key from the new object
    return newEmployee; // Return the new object
  }
  
  // Destructive: removes the key-value pair from the original employee object
  function destructivelyDeleteFromEmployeeByKey(employee, key) {
    delete employee[key]; // Remove the key-value pair from the original object
